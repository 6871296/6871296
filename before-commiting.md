...
1. 所有仓库的issues界面（`6871296.git`除外，这里的issues就是聊天区）**只能用于bug报告、未来规划建议和其它项目相关的问题。** 请不要在里面聊天。
2. 不要发布**空白或过于无用的**issue。
3. 在提issue时，请**明确说明你想干什么**。比如你在`languanges-site.git`里说“添加某某Web语言”，不要让别人以为你想要在项目里使用这个语言实现某个功能。
4. **LAST BUT NOT LEAST**，我写issue基本都是bug报告，最好也看看discussions。

# Discussions相关

1. **选对Category**。尽管我可以给你转，但那样处理会很麻烦。
2. 同issues相关第1~3条，不要发水贴，说话要明确。
